...
/**
 * 
 * chunks' magic numbers enum{ CHUNK_HEAD = 0x00080003,
 * 
 * CHUNK_STRING = 0x001c0001, CHUNK_RESOURCE = 0x00080180,
 * 
 * CHUNK_STARTNS = 0x00100100, CHUNK_ENDNS = 0x00100101, CHUNK_STARTTAG =
 * 0x00100102, CHUNK_ENDTAG = 0x00100103, CHUNK_TEXT = 0x00100104, };
 * 
 * @author i
 *
 */
